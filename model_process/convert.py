...
def convert_llava_to_hf(model_id, pytorch_dump_folder_path, push_to_hub=False):
    ...
    filepath = f"{model_id}/config.json"
    print(filepath)
    # read json
    ...
    if model_id in ["lmms-lab/llava-onevision-qwen2-0.5b-ov", "lmms-lab/llava-onevision-qwen2-0.5b-si"]:
        ...
        text_model_id = "/mnt/lingjiejiang/multimodal_code/checkpoints/llms/Qwen2.5-Coder-7B-Instruct"        
...
# python model_process/convert.py --model_id /mnt/lingjiejiang/multimodal_code/checkpoints/vlms/llavanext-siglip-so400m-patch14-384-Qwen2.5-Coder-7B-Instruct-mlp2x_gelu-mid_stage_14336 --pytorch_dump_folder_path /mnt/lingjiejiang/multimodal_code/checkpoints/vlms/temp