...
# 加载数据集  
ds = load_dataset("/mnt/lingjiejiang/multimodal_code/data/llava_onevision/LLaVA-ReCap-CC3M")  
train_data = ds["train"]  
  
# 定义图像和JSON文件的输出路径  
output_image_path = "/mnt/lingjiejiang/multimodal_code/data/llava_onevision/LLaVA-ReCap-CC3M/cc3m/"  
output_json_file = "/mnt/lingjiejiang/multimodal_code/data/llava_onevision/LLaVA-ReCap-CC3M/cc3m_recap_data_prompt_v2.json"  
...
def process_entry(entry):  
    ...
    try:  
        ...
        new_entry = {  
            "id": img_id,  
            "image_temp": f"cc3m/{image_filename}",  
