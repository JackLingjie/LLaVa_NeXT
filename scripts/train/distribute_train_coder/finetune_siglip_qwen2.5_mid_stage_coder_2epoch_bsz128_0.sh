...
LLM_VERSION="/mnt/lingjiejiang/multimodal_code/checkpoints/llms/Qwen2.5-Coder-7B-Instruct"
# LLM_VERSION_CLEAN="${LLM_VERSION//\//_}"
LLM_VERSION_CLEAN="Qwen2.5-Coder-7B-Instruct"
...
MID_RUN_NAME="llavanext-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}_${MAX_MODEL_LEN}_epoch${EPOCH}_2nodes_bsz128"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --nnodes="${NNODES}" --node_rank="${RANK}" --master_addr="${ADDR}" --master_port="${PORT}" \
    ...
    --data_path scripts/train/mid_stage_mypath_code.yaml \
    --image_folder /mnt/lingjiejiang/multimodal_code/data/llava_onevision/LLaVA-ReCap-558K \
    --pretrain_mm_mlp_adapter="/mnt/lingjiejiang/multimodal_code/checkpoints/projectors/llavanext-siglip-so400m-patch14-384-Qwen2.5-Coder-7B-Instruct-mlp2x_gelu-pretrain_blip558k_plain/mm_projector.bin" \
