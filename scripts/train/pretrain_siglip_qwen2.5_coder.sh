...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" \
    ...
    --image_folder /mnt/lingjiejiang/multimodal_code/data/llava_onevision/LLaVA-Pretrain \
    ...
    --bf16 True \
    --output_dir /mnt/lingjiejiang/multimodal_code/checkpoints/projectors/${BASE_RUN_NAME} \
    --num_train_epochs 1 \
